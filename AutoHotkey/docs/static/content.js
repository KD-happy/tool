...
// 设置网页图标
(function() {
  if(document.querySelector('[rel="shortcut icon"]') == null) {
    var myIcon = document.createElement("link");
    myIcon.setAttribute('rel', 'shortcut icon');
    myIcon.setAttribute('type', 'image/x-icon');
    myIcon.setAttribute('href', 'https://kdlong.gitee.io/img/favicon.png');
