(function (e) {
    ...
    1020: function (e, t, a) {
        ...
        var n = a("3835"),
            ...
            s = { mp3: "audio/mpeg", flac: "audio/flac" };
        function u(e) {
                            ...
                            [
                                ...
                                a(
                                    ...
                                    [
                                        a("el-row", [
                                            e._v(
                                                " 音乐解锁：移除已购音乐的加密保护。 目前支持网易云音乐(ncm)和QQ音乐(qmc0, qmc3, qmcflac, qmcogg, mflac)。 "
                                            ),
                                            a(
                                                "a",
                                                {
                    ...
                    finishLoad: function () {
                        /* document.getElementById("loader-mask").remove(),
                            this.$notify.info({
                                title: "离线使用",
                                message:
                                    '我们使用PWA技术，无网络也能使用<br/>最近更新：支持qmcogg,mflac<br/>点击查看 <a target="_blank" href="https://github.com/ix64/unlock-music/wiki/使用提示">使用提示</a>',
                        ...
                        case 16:
                            return (
                                ...
                                ((g = f.common.picture[0]),
                                    (v = new Blob([g.data], { type: g.format })),
    ...
    b5de: function (e, t, a) {
        ...
        a("baa5"),
            ...
            a("96cf");
        var n = a("cb96"),
            r = { mp3: "audio/mpeg", flac: "audio/flac" };
        function i(e) {
    ...
    d26a: function (e, t, a) {
        ...
        var n = a("d4ec"),
            ...
            c = { mp3: "audio/mpeg", flac: "audio/flac", ogg: "audio/ogg" };
        function s(e) {
                        ...
                        case 23:
                            return (
                                ...
                                ((y = p.common.picture[0]),
                                    (x = new Blob([y.data], { type: y.format })),
